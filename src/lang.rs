...
pub static EN: Text = Text {
    ...
    note: "{} toggles this window  |  Edits apply live, Save writes {} next to the exe",
    close: "Close",
    ...
    ui_scale: "UI scale",
    ui_scale_hint: "Size of this window's text and controls (1.00 = match the display)",
    section_keys: "Keys",
    add_key: "+ Add key",
    binding_hint: "Click a binding, then press the key you want to use",
    key_name: "(key name)",
    press_key: "<- press a key or a mouse button ->",
    release_key: "release...",
...
pub static ZH: Text = Text {
    ...
    ui_scale: "界面缩放",
    ui_scale_hint: "本窗口文字与控件的大小（1.00 = 跟随显示器）",
    section_keys: "按键",
    add_key: "+ 添加按键",
